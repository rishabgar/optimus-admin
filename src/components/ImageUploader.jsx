...
export default function ImageUploader({ onUploadSuccess, currentUserId, label = "Upload Image" }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
      <label className="label-md" style={{ color: "var(--on-surface-variant)" }}>
        {label}
      </label>
      ...
      {uploadedPath && !error && (
        <span style={{ fontSize: "0.75rem", color: "var(--primary)", wordBreak: "break-all", marginTop: "0.2rem" }}>
